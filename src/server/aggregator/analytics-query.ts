...
const supportedTopicsAnswer =
  "Analytics is available through the MCP endpoint, but no project-specific analytics adapters are configured in this base template yet.";
...
export const findAnalyticsApi = (
  ...
  return {
    mode: "unsupported",
    confidence: 0.1,
    reason: "No project-specific analytics adapters are configured in this base template.",
